...
public class TitleEditor extends Activity {
     ...
     */
    public static final String EDIT_TITLE_ACTION = "info.guardianproject.notecipher.action.EDIT_TITLE";
    ...
    protected void onPause() {
        ...
        if (mCursor != null) {
            ...
            values.put(NoteCipher.Notes.COLUMN_NAME_TITLE, mText.getText().toString());
