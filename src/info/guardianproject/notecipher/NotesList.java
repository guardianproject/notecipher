...
import net.sqlcipher.auth.SQLCipherOwner;
import net.sqlcipher.auth.SQLCipherStateManager;
import info.guardianproject.notecipher.NoteCipher;
 ...
 * contents of the {@link NoteCipherProvider}.
 *
 ...
 */
public class NotesList extends ListActivity implements SQLCipherOwner
{
    ...
    private static final String[] PROJECTION = new String[] {
            NoteCipher.Notes._ID, // 0
            NoteCipher.Notes.COLUMN_NAME_TITLE, // 1
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getData() == null) {
            intent.setData(NoteCipher.Notes.CONTENT_URI);
        }
	...
	protected void onResume() {
        ...
        //TODO this is a bad way to do this, but works for now
	...
	private void loadList ()
    {
        ...
        String[] dataColumns = { NoteCipher.Notes.COLUMN_NAME_TITLE } ;
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        final boolean haveItems = true;// getListAdapter().getCount() > 0;
	...
	public void unlockDatabase(String passcode) throws Exception {
		...
		NoteCipherProvider.cachePasscode = passcode;
		loadList();
