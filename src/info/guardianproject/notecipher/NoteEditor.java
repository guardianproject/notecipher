...
public class NoteEditor extends Activity {
    ...
    private static final String[] PROJECTION =
        new String[] {
            NoteCipher.Notes._ID,
            NoteCipher.Notes.COLUMN_NAME_TITLE,
            NoteCipher.Notes.COLUMN_NAME_NOTE
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_EDIT.equals(action)) {
        	...
        	Log.d(TAG, " ABOUT TO INSERT NOTE!! ");
            ...
            try {
            	...
            	// Reset any (probably wrong) password. If we get this SQLiteException, its possible
            	// we came from Insert button, via the password dialog , with an incorrect password.
            	// When we call finish() below, if the cachePasscode isnt null, we try to load - and get
            	// more errors.
            	NoteCipherProvider.cachePasscode = null;
            	
            	Log.e(TAG, "SQLiteException in onCreate.\n" + e.getMessage());
            }
            
            Log.d(TAG, " Got mUri - " + mUri);
            /*
    ...
    protected void onResume() {
        ...
        if (mCursor != null) {
            ...
            if (mState == STATE_EDIT) {
                ...
                int colTitleIndex = mCursor.getColumnIndex(NoteCipher.Notes.COLUMN_NAME_TITLE);
            ...
            int colNoteIndex = mCursor.getColumnIndex(NoteCipher.Notes.COLUMN_NAME_NOTE);
    ...
    private final void performPaste() {
        ...
        if (clip != null) {
            ...
            if (uri != null && NoteCipher.Notes.CONTENT_ITEM_TYPE.equals(cr.getType(uri))) {
	...
	*/
    ...
    private final void updateNote(String text, String title) {
        ...
        values.put(NoteCipher.Notes.COLUMN_NAME_MODIFICATION_DATE, System.currentTimeMillis());
        ...
        if (mState == STATE_INSERT) {
            ...
            values.put(NoteCipher.Notes.COLUMN_NAME_TITLE, title);
        } else if (title != null) {
            // In the values map, sets the value of the title
            values.put(NoteCipher.Notes.COLUMN_NAME_TITLE, title);
        }
        ...
        values.put(NoteCipher.Notes.COLUMN_NAME_NOTE, text);
    ...
    private final void cancelNote() {
        if (mCursor != null) {
            if (mState == STATE_EDIT) {
                ...
                mCursor = null;
                ContentValues values = new ContentValues();
                values.put(NoteCipher.Notes.COLUMN_NAME_NOTE, mOriginalContent);
