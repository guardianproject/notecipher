 ...
 */
public abstract class SQLCipherProgram extends SQLiteClosable {
     ...
     */
    @Deprecated
    protected SQLCipherDatabase mDatabase;
     ...
     */
    private SQLCipherCompiledSql mCompiledSql;
    ...
    /* package */ SQLCipherProgram(SQLCipherDatabase db, String sql) {
        mDatabase = db;
        mSql = sql.trim();
        db.acquireReference();
        ...
        if (!prefixSql.equalsIgnoreCase("INSERT") && !prefixSql.equalsIgnoreCase("UPDATE") &&
            ...
            mCompiledSql = new SQLCipherCompiledSql(db, sql);
    ...
    private void releaseCompiledSqlIfNotInCache() {
        ...
        // TODO implement compiled queries
        /*
