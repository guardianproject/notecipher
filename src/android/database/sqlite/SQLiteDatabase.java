...
//    /* package */ Map<String, SQLiteCompiledSql> mCompiledQueries = Maps.newHashMap();
    ...
    public interface CursorFactory {
         ...
         * String, SQLCipherQuery)}.
         */
        public Cursor newCursor(SQLiteDatabase db,
                SQLiteCursorDriver masterQuery, String editTable,
                SQLCipherQuery query);
    }
    ...
    public int getVersion() {
    	// contents deleted to eliminate errors
    	return 1;
    }
     ...
     * statement and fill in those values with {@link SQLCipherProgram#bindString}
     * and {@link SQLCipherProgram#bindLong} each time you want to run the
     * statement. Statements may not return result sets larger than 1x1.
     *
     * @param sql The raw SQL statement, may contain ? for unknown values to be
     *            bound later.
     * @return A pre-compiled {@link SQLCipherStatement} object. Note that
     * {@link SQLCipherStatement}s are not synchronized, see the documentation for more details.
     */
     ...
     *
     * if there is already a {@link SQLCipherCompiledSql} in compiledQueries for the given sql,
     * the new {@link SQLCipherCompiledSql} object is NOT inserted into the cache (i.e.,the current
     * mapping is NOT replaced with the new mapping).
     */
    /* package */ void addToCompiledQueries(String sql, SQLCipherCompiledSql compiledStatement) {
    	// contents deleted to avoid errors
    }
    ...
    /* package */ SQLCipherCompiledSql getCompiledStatementForSql(String sql) {
        ...
        // contents deleted to remove errors
