 ...
 * Once a sql statement is compiled, it is cached in {@link SQLCipherDatabase}
 * and it is released in one of the 2 following ways
 * 1. when {@link SQLCipherDatabase} object is closed.
 * 2. if this is not cached in {@link SQLCipherDatabase}, {@link android.database.Cursor#close()}
 * releaases this obj.
 */
/* package */ class SQLCipherCompiledSql {

    private static final String TAG = "SQLCipherCompiledSql";

    /** The database this program is compiled against. */
    /* package */ SQLCipherDatabase mDatabase;
    ...
    /* package */ SQLCipherCompiledSql(SQLCipherDatabase db, String sql) {
        if (!db.isOpen()) {
